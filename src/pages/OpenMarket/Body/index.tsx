				...
				<div>
					<div>
						...
						<p>
							...
							prospects. Key presumptions and market insights are presented, predicted revenue and expenses
							are modelled, and potential risks are examined.
						</p>
					</div>
					<div>
						<h3>Solution</h3>
				...
				<div>
					...
					<div>
						...
						<div>
							...
							<p>
								Commercial loans are not profitable to the local market merchants, the loan requirements are
								also burdensome. Their needs are daily or weekly working capital they can buy stocks or pay
								production cost, to generate instant income and pay small interest on such loan weekly.
							</p>
						</div>
						<div>
							<h3>LOW MARGINS</h3>
					...
					<div>
						<div>
							...
							<ul>
								...
								<li>
									High comfort with cash, has also impeded the opportunity for the growth of digital payments
								</li>
							</ul>
						</div>
						<div>
