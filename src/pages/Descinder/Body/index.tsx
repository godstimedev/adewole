					...
					<div>
						<div>
							...
							<p>
								...
								create innovative solutions for business and also giver early career individuals to get
								their first time real job experience.
							</p>
							<p>
								{' '}
					...
					<div>
						...
						<div>
							...
							<p>
								...
								This ensures a coherent usability flow for all users and actors on the platform,
								contributing to the creation of a user-friendly and user-centric solution.
							</p>
							<div className="flow">
